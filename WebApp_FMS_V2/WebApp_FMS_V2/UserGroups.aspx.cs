    ...
    public partial class UserGroups : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "UserGroup", "Page_Load", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
        ...
        protected void btnUGDetails_SaveYes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Save User Group
                wcfService.Save_UserGroups(_gc.ToInt32(hfUserGroupID.Value), txtUGDetails_GroupName.Text, txtUGDetails_Description.Text, chkUGDetails_Active.Checked, _gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), (string)Session["tID"]);
                ...
                wcfService.Trails_UserTrails(0, _gc.ToInt32(hfUserGroupID.Value), 0, _TransType);

                //Save Transaction Logs
                int _UID = 0;
                if (!string.IsNullOrEmpty(Session["UserID"] as string)) { _UID = _gc.ToInt32(_Cypher.Decrypt(Session["UserID"].ToString(), _Cypher._PassPhrase)); }

                wcfService.Save_TransactionLogs(_UID, "UserGroups", "btnUGDetails_SaveYes_Click", _TransType, _gc.localComputerName, _gc.GetIPAddress());
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "UserGroups", "btnUGDetails_SaveYes_Click", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
            }
            finally
            {
                _gc.DeserializeDataTable(wcfService.Get_UserGroups("", _gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), (string)Session["tID"])
        ...
        protected void lnkUserGroup_Search_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "UserGroup", "lnkUserGroup_Search_Click", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
                Response.Redirect("Login");
            }
        }
        ...
        protected void gvUserGroupsList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "UserGroup", "gvUserGroupsList_RowCommand", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
            }
        }
