<%@ Page Title="" Language="C#" MasterPageFile="~/FMS.Master" AutoEventWireup="true" CodeBehind="Office.aspx.cs" Inherits="WebApp_FMS_V2.Office" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Office - Requisition System
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <asp:MultiView ID="mvOffice" runat="server">
        ...
        <asp:View ID="vwDetailsOffice" runat="server">
            ...
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="lblOfficeDetails_Code" runat="server" Text="Code **" />
            ...
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="lblOfficeDetails_Name" runat="server" Text="Name **" />
