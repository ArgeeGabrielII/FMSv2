<%@ Page Title="" Language="C#" MasterPageFile="~/FMS.Master" AutoEventWireup="true" CodeBehind="GroupRights.aspx.cs" Inherits="WebApp_FMS_V2.GroupRights" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Group Rights - Requisition System
</asp:Content>
                ...
                <div class="panel-body">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Module Group Rights</a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Requisition Group Rights</a>
                                </h4>
                            </div>
                            <div id="collapseTwo" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <asp:GridView runat="server" ID="gvGroupRights_Requestition" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover"
                                        HeaderStyle-HorizontalAlign="Center">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Group Right Request ID" HeaderStyle-CssClass="hide" ItemStyle-CssClass="hide">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblGroupRightRequestID" Text='<%# Bind("GroupRightRequestID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Group ID" HeaderStyle-CssClass="hide" ItemStyle-CssClass="hide">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Process ID" HeaderStyle-CssClass="hide" ItemStyle-CssClass="hide">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblRequestProcessID" Text='<%# Bind("RequestProcessID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Request Process Name" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblRequestProcessName" Text='<%# Bind("RequestProcessName") %>' Enabled="false"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Can View" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
