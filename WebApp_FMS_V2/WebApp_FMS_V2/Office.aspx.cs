    ...
    public partial class Office : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "Office", "Page_Load", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
        ...
        protected void lnkOfficeView_Search_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "Office", "lnkOfficeView_Search_Click", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
                Response.Redirect("Login");
            }
        }
        ...
        protected void btnOfficeDetails_SaveYes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Save Office
                wcfService.Save_Office(_gc.ToInt32(hfOfficeID.Value), txtOfficeDetails_Code.Text, txtOfficeDetails_Name.Text, chkOfficeDetails_Active.Checked
                ...
                wcfService.Trails_UserTrails(_gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), _gc.ToInt32(hfOfficeID.Value), 0, _TransType);

                //Save Transaction Logs
                int _UID = 0;
                if (!string.IsNullOrEmpty(Session["UserID"] as string)) { _UID = _gc.ToInt32(_Cypher.Decrypt(Session["UserID"].ToString(), _Cypher._PassPhrase)); }

                wcfService.Save_TransactionLogs(_UID, "Office", "btnOfficeDetails_SaveYes_Click", _TransType, _gc.localComputerName, _gc.GetIPAddress());
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "Office", "btnOfficeDetails_SaveYes_Click", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
            }
            finally
            {
                _gc.DeserializeDataTable(wcfService.Get_Office("", _gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), (string)Session["tID"])
        ...
        protected void gvOfficeList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "Select")
                {
                    ...
                    chkOfficeDetails_Active.Checked = _gc.Load_CheckBox(row.Cells[3].Text);
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "Office", "gvOfficeList_RowCommand", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
            }
        }
