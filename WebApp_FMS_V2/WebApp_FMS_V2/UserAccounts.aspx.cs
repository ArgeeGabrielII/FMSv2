    ...
    public partial class UserAccounts : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    _gc.DeserializeDropDownList(wcfService.Get_Departments("", _gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), (string)Session["tID"])
                    ...
                    _gc.DeserializeDropDownList(wcfService.Get_Office("", _gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), (string)Session["tID"])
                        , "OfficeName", "OfficeCode", ddlUADetails_Office);
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "UserAccounts", "Page_Load", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
        ...
        protected void btnUADetails_SaveYes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                wcfService.Trails_UserTrails(0, _gc.ToInt32(hfUserID.Value), 0, _TransType);

                //Save Transaction Logs
                int _UID = 0;
                if (!string.IsNullOrEmpty(Session["UserID"] as string)) { _UID = _gc.ToInt32(_Cypher.Decrypt(Session["UserID"].ToString(), _Cypher._PassPhrase)); }

                wcfService.Save_TransactionLogs(_UID, "UserAccounts", "btnUADetails_SaveYes_Click", _TransType, _gc.localComputerName, _gc.GetIPAddress());
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "UserAccounts", "btnUADetails_SaveYes_Click", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
            }
            finally
            {
                _gc.DeserializeDataTable(wcfService.Get_UserAccount("", _gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), (string)Session["tID"])
        ...
        protected void lnkUserAccount_Search_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "UserAccounts", "lnkUserAccount_Search_Click", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
                Response.Redirect("Login");
            }
        }
        ...
        protected void gvUserAccountsList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "Select")
                {
                    ...
                    txtUADetails_Password1.Text = row.Cells[2].Text;
                    txtUADetails_Password2.Text = row.Cells[2].Text;
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "UserAccounts", "gvUserAccountsList_RowCommand", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
            }
        }
