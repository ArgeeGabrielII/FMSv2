<%@ Page Title="" Language="C#" MasterPageFile="~/FMS.Master" AutoEventWireup="true" CodeBehind="UserAccounts.aspx.cs" Inherits="WebApp_FMS_V2.UserAccounts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    User Accounts - Requisition System
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <asp:MultiView ID="mvUserAccounts" runat="server">
        ...
        <asp:View ID="vwDetailsUserAccounts" runat="server">
            ...
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="lblUADetails_Password1" runat="server" Text="Password **" />
                    <asp:TextBox ID="txtUADetails_Password1" runat="server" CssClass="form-control" placeholder="Password" TextMode="Password" />
                </div>
                <div class="col-md-4">
                    <asp:Label ID="lblUADetails_Password2" runat="server" Text="Password **" />
                    <asp:TextBox ID="txtUADetails_Password2" runat="server" CssClass="form-control" placeholder="Verify Password" TextMode="Password" />
                </div>
            </div>
            <br />
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group input-group">
                        <asp:Label ID="lblUADetails_UserGroup" runat="server" Text="User Group **" />
                        <asp:DropDownList ID="ddlUADetails_UserGroup" runat="server" CssClass="form-control" />
                        <span class="input-group-btn">
                            <a href="UserGroups" class="btn btn-default btnTop10">•••</a>
                        </span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group input-group">
                        <asp:Label ID="lblUADetails_Department" runat="server" Text="Department **" />
                        <asp:DropDownList ID="ddlUADetails_Department" runat="server" CssClass="form-control" />
                        <span class="input-group-btn">
                            <a href="DepartmentApprover" class="btn btn-default btnTop10">•••</a>
                        </span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group input-group">
                        <asp:Label ID="lblUADetails_Office" runat="server" Text="Office **" />
                        <asp:DropDownList ID="ddlUADetails_Office" runat="server" CssClass="form-control" />
                        <span class="input-group-btn">
                            <a href="Office" class="btn btn-default btnTop10">•••</a>
                        </span>
                    </div>
                </div>
            </div>
