<%@ Page Title="" Language="C#" MasterPageFile="~/FMS.Master" AutoEventWireup="true" CodeBehind="UserGroups.aspx.cs" Inherits="WebApp_FMS_V2.UserGroups" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    User Groups - Requisition System
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <asp:MultiView ID="mvUserGroup" runat="server">
        ...
        <asp:View ID="vwDetailsUserGroup" runat="server">
            ...
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="lblUGDetails_GroupName" runat="server" Text="Group Name **" />
