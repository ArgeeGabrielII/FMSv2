...
{
    public partial class PageModules : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!Page.IsPostBack)
                {
                    _gc.DeserializeDataTable(wcfService.Get_PageModules("", _gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), (string)Session["tID"])
                      , gvPageModulesList);
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "PageModules", "Page_Load", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
        ...
        protected void lnkPageModulesView_Search_Click(object sender, EventArgs e)
        {
            try
            {
                _gc.DeserializeDataTable(wcfService.Get_PageModules(txtPageModulesView_Search.Text, _gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), (string)Session["tID"])
                    , gvPageModulesList);
            }
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "PageModules", "lnkPageModulesView_Search_Click", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
                Response.Redirect("Login");
            }
        }
        ...
        protected void btnPageModulesDetails_SaveYes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Save Page Modules
                wcfService.Save_PageModules(_gc.ToInt32(hfPageModulesID.Value), txtPageModulesDetails_Name.Text, txtPageModulesDetails_Description.Text, txtPageModulesDetails_URL.Text
                ...
                wcfService.Trails_UserTrails(_gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), _gc.ToInt32(hfPageModulesID.Value), 0, _TransType);

                //Save Transaction Logs
                int _UID = 0;
                if (!string.IsNullOrEmpty(Session["UserID"] as string)) { _UID = _gc.ToInt32(_Cypher.Decrypt(Session["UserID"].ToString(), _Cypher._PassPhrase)); }

                wcfService.Save_TransactionLogs(_UID, "PageModules", "btnPageModulesDetails_SaveYes_Click", _TransType, _gc.localComputerName, _gc.GetIPAddress());
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "PageModules", "btnPageModulesDetails_SaveYes_Click", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
            }
            finally
            {
                _gc.DeserializeDataTable(wcfService.Get_PageModules("", _gc.ToInt32(_Cypher.Decrypt((string)Session["UserID"], _Cypher._PassPhrase)), (string)Session["tID"])
        ...
        protected void gvPageModulesList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                wcfService.Save_TransactionLogs(_UID, "PageModules", "gvPageModulesList_RowCommand", ex.ToString(), _gc.localComputerName, _gc.GetIPAddress());
            }
        }
